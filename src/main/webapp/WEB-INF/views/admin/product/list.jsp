        ...
        <div class="col-md-12 mb-3">
            <div class="card text-white bg-warning">
                <div class="card-body">
                    ...
                    <small>Tổng số sản phẩm trong hệ thống</small>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="col-12">
            <div class="card mb-4">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <a href="<c:url value='/admin/products/create'/>" class="btn btn-outline-warning">
                                ...
                                <c:otherwise>
                                    <c:forEach var="p" items="${products}">
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<c:url value='/admin/products/${p.id}/edit'/>"
...
<!-- Form xóa ẩn -->
<form id="deleteForm" method="post" action="<c:url value='/admin/products/delete'/>">
